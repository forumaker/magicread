...
app.initializers.add('forumaker-magicread', () => {
  ...
  TextEditor.prototype.onupdate = function (this: MagicReadEditor, vnode: any) {
    ...
    const ta = getTextarea(this);
    if (ta && this.magicReadUpdate && this.magicReadTa !== ta) {
      if (this.magicReadTa) this.magicReadTa.removeEventListener('input', this.magicReadUpdate);
      ta.addEventListener('input', this.magicReadUpdate);
      this.magicReadTa = ta;
      this.magicReadUpdate();
    }
  ...
  TextEditor.prototype.onremove = function (this: MagicReadEditor, vnode: any) {
    try {
      if (this.magicReadTa && this.magicReadUpdate) {
        this.magicReadTa.removeEventListener('input', this.magicReadUpdate);
      }
      this.magicReadTa = null;
